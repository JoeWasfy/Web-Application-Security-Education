...
urlpatterns = [
    ...
    path('lab_5/login/my_account/', views.my_account, name='my_account'), 
    ...
    path('my-account/', views.my_account1, name='my-account'),  
    ...
    path('update-points/', views.update_user_points, name='update-points'),
